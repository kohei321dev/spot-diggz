...
-- +goose Down
DROP INDEX IF EXISTS idx_sdz_spots_tag_keys;
DROP INDEX IF EXISTS idx_sdz_spots_lng_lat_active;
DROP INDEX IF EXISTS idx_sdz_spots_visibility_active;
DROP TABLE IF EXISTS sdz_spots;
