...
- Supersedes: None
- Superseded By: [ADR-0010](0010-google-maps-provider-and-fallback.md)（origin/providerのみ）、[ADR-0011](0011-five-prefecture-mvp-scope.md)（地理scopeのみ）、[DR-0019](0019-api-client-boundary.md)（独自Web UIの提供要件のみ）、[DR-0020](0020-mention-nearby-search.md)（新MVPの6条件必須・即時滑走推薦/固定3件を周辺検索へ置換）
