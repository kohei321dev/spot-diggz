...
- Superseded By: [DR-0018](0018-api-first-product-definition.md)（利用者検証・Productの地理scope）、[DR-0022](0022-domestic-catalog-quality.md)（schema・validatorの5府県制約。既存収録データは維持）
